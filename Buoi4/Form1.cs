...
namespace Buoi4
{
    public partial class Form1 : Form
    {
        ...
        {
            // set default khoa items and selection
            cbKhoa.Items.Clear();
            ...
            dgvStudents.AutoGenerateColumns = true; // let it generate from Student properties
        ...
        {
            // load dữ liệu ngược lại phần nhập liệu
